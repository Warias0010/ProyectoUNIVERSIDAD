...
<head>
	...
	<?php include "includes/scripts.php"; ?>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="./factura1/css/bootstrap.min.css" rel="stylesheet">

        <!-- MetisMenu CSS -->
        <link href=".factura1//css/metisMenu.min.css" rel="stylesheet">

        <!-- Timeline CSS -->
        <link href="./factura1/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="./factura1/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="./factura1/css/morris.css" rel="stylesheet">

        <!-- Custom Fonts -->
        <link href="./factura1/css/font-awesome.min.css" rel="stylesheet" type="text/css">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <a href="#">
                                    <div class="panel-footer">
                                        <span class="pull-left">Total Facturas</span>
