 ...
 ?>
	<header>
		<div class="header">
			...
			<div class="optionsBar">
				...
				<span>|</span>
				<span class="user"><?php echo $_SESSION['nombre'].' -'.$_SESSION['user'].' -'.$_SESSION['email']; ?></span>
	...
	<div class="modal">
		<div class="bodymodal">
			...
			<input type="text" name="precio" id="txtprecio" placeholder="Ingrese Nuevo precio en C$" required><br>
